...
my $head_called = 0;
{
	...
	ok(ref($other_handle) eq 'Net::Curl::Easy', 'Dup handle looks like an object from the Net::Curl::Easy module'); #13
...
ok(ref($third) eq 'Net::Curl::Easy', 'Dup handle looks like an object from the Net::Curl::Easy module');
